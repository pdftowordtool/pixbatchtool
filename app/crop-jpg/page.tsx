...
import enDict from '@/dictionaries/en/crop-jpg.json'
import esDict from '@/dictionaries/es/crop-jpg.json'
import deDict from '@/dictionaries/de/crop-jpg.json'
import itDict from '@/dictionaries/it/crop-jpg.json'
...
export default function CropJPGPage() {
  ...
  const downloadResult = () => { if (!croppedBlob || !originalFile) return; const a = document.createElement('a'); a.href = URL.createObjectURL(croppedBlob); a.download = `cropped-${originalFile.name.split('.')[0]}.jpg`; a.click() }
